...
class EditPatient:
    ...
    def to_JSON(self):
        return {
            ...
            "energia": self.energy,
            "fiebre": self.fever,
            "dolorPecho": self.chest_pain,
            "mareos": self.dizziness,
            "tempAlta": self.high_temperature,
            "sudores": self.sweating,
            "palpitaciones": self.palpitations,
            "taquicardiaReposo": self.resting_tachycardia,
            "caidas": self.falls,
            "inestabilidad": self.instability,
            "cambioLugar": self.change_of_location,
            "dificultadEjercicio": self.exercise_difficulty,
            "disneaActividades": self.dyspnea_activities,
            "frutasVerduras": self.fruits_vegetables,
            "agua": self.water,
            "actividadFisica": self.physical_activity,
            "horasSueño": self.sleep_hours,
            "despertarNocturno": self.nighttime_waking,
            "historiaMedica": self.medical_history,
            "medicamentos": self.medications,
            "antecedentesCardiacos": self.cardiac_history,
            "antecedentesRespiratorios": self.respiratory_history,
            "obesidad": self.obesity,
            "diabetesFamilia": self.family_diabetes,
            "diabetes": self.diabetes,
            "enfermedadCronica": self.chronic_disease,
            "cualEnfermedad": self.disease_details     
        }