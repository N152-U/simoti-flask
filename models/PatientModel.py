...
CASE WHEN pgs.fruits_vegetables THEN '1' ELSE '0' END fruits_vegetables,
CASE WHEN pgs.water THEN '1' ELSE '0' END water,
CASE WHEN pgs.physical_activity THEN '1' ELSE '0' END physical_activity,
CASE WHEN pgs.sleep_hours THEN '1' ELSE '0' END sleep_hours,
CASE WHEN pgs.nighttime_waking THEN '1' ELSE '0' END nighttime_waking,
CASE WHEN pgs.medical_history THEN '1' ELSE '0' END medical_history,
CASE WHEN pgs.medications THEN '1' ELSE '0' END medications,
CASE WHEN pgs.cardiac_history THEN '1' ELSE '0' END cardiac_history,
CASE WHEN pgs.respiratory_history THEN '1' ELSE '0' END respiratory_history,
CASE WHEN pgs.obesity THEN '1' ELSE '0' END obesity,
phb.family_diabetes,
phb.diabetes,
CASE WHEN pgs.chronic_disease THEN '1' ELSE '0' END chronic_disease,
phb.disease_details
FROM patients p 
INNER JOIN patient_general_status pgs ON pgs.patient_id = p.id
INNER JOIN patient_habits_and_backgrounds phb ON phb.patient_id = p.id
